    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(default='Sin Marca asignada', max_length=30, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Producto',
            fields=[
                ...
                ('modelo', models.CharField(max_length=30, primary_key=True, serialize=False, unique=True)),
